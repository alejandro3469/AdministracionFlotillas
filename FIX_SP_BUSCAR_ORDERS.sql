-- =============================================
-- FIX: Corregir SP_BUSCAR_ORDERS para evitar error ORA-01006
-- Problema: SQL dinámico con USING pasaba todos los parámetros (incluso NULL)
-- Solución: Consulta estática que maneja NULLs correctamente
-- =============================================
