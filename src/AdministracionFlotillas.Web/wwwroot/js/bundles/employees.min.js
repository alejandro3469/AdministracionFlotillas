    ...
    function (n) {
        ...
        n.Employees.Table = {
            ...
            _getButtons: function () {
                ...
                return [
                    ...
                    {
                        text: '<i class="fas fa-chart-bar" aria-hidden="true"></i> Resumen',
                        className: "btn btn-sm btn-outline-primary",
                        titleAttr: "Ver resumen de empleados",
                        action: function () {
                            window.location.href = "/Employees/Resumen";
                        }
                    },
                    {
                        extend: "excel",
                    ...
                    {
                        text: '<span id="contadorEmpleados" style="margin-left: 10px; font-weight: 500; color: #495057;">0 Empleados seleccionados</span>',
                        action: function () {
                            // solo es para mostrar
                        },
                        className: "btn-plain-counter",
                        titleAttr: "Cantidad de empleados seleccionados"
                    }
                ];
            },
        ...
        n.Employees.Filters = {
            ...
            Apply: function () {
                ...
                u = function (n, t, r) {
                    ...
                    var salarioAnualMinVal = $("#filtroSalarioAnualMin").val();
                    var salarioAnualMaxVal = $("#filtroSalarioAnualMax").val();
                    var salarioAnualMin = null;
                    var salarioAnualMax = null;
                    if (salarioAnualMinVal) {
                        salarioAnualMin = parseFloat(salarioAnualMinVal.replace(/[^0-9.-]+/g, ""));
                    }
                    if (salarioAnualMaxVal) {
                        salarioAnualMax = parseFloat(salarioAnualMaxVal.replace(/[^0-9.-]+/g, ""));
                    }
                    var ft = r,
                        et = i.row(ft),
                        u = et.data();
                    ...
                    if (salarioAnualMin !== null || salarioAnualMax !== null) {
                        var salarioAnualEmpleado = u.salarioAnual;
                        if (salarioAnualEmpleado && salarioAnualEmpleado !== "-") {
                            var salarioAnualNum = parseFloat(salarioAnualEmpleado.replace(/[^0-9.-]+/g, ""));
                            if (isNaN(salarioAnualNum) ||
                                (salarioAnualMin !== null && salarioAnualNum < salarioAnualMin) ||
                                (salarioAnualMax !== null && salarioAnualNum > salarioAnualMax)) {
                                return !1;
                            }
                        } else {
                            return !1;
            ...
            _initializeSalaryInputs: function () {
                if (typeof $.fn.inputmask != "undefined") {
                    ...
                    var salarioAnualMin = $("#filtroSalarioAnualMin"),
                        salarioAnualMax = $("#filtroSalarioAnualMax");

                    if (salarioAnualMin.length > 0) {
                        salarioAnualMin.inputmask({
                            alias: "numeric",
                            groupSeparator: ",",
                            autoGroup: !0,
                            digits: 2,
                    ...
                    if (salarioAnualMax.length > 0) {
                        salarioAnualMax.inputmask({
                            alias: "numeric",
                            groupSeparator: ",",
                            autoGroup: !0,
                            digits: 2,
            ...
            _initializeTextFilters: function () {
                ...
                $("#filtroSalarioAnualMin, #filtroSalarioAnualMax").off("input blur change keyup");
            }
        };
        n.Employees.Selection = {
            ...
            UpdateCounter: function () {
                var count = t.length;
                var counterText = count + " Empleado" + (count !== 1 ? "s" : "") + " seleccionado" + (count !== 1 ? "s" : "");

                // Actualizar el texto del contador en pantalla
                $("#contadorEmpleados").text(counterText);
            }
        };
        n.Employees.Email = {
            OpenModal: function () {
                ...
                i && i.rows().every(function () {
                    ...
                    t.find(selected => selected.id === rowData.idEmpleado) && n.push(rowData);
                });
                r = $("#tablaResumenEmpleados");
                r.empty();
                n.forEach(function (n) {
                    var t = "<tr><td>" + (n.nombreCompleto || n.primerNombre + " " + n.apellido) + "<\/td><td>" + n.correoElectronico + "<\/td><td>" + n.emailPersonal + "<\/td><td>" + (n.numeroTelefono || "-") + "<\/td><td>" + n.fechaContratacion + "<\/td><td>" + (n.salario || "-") + "<\/td><td>" + n.salarioAnual + "<\/td><td>" + (n.idDepartamento ? "Dept. " + n.idDepartamento : "-") + "<\/td><\/tr>";
                    r.append(t);
                });
                var $emailInput = $("#modalEnviarEmail #emailReceptor");
                var $infoMultiple = $("#emailMultipleInfo");

                if (n.length === 1) {
                    // Un solo empleado
                    var email = n[0].correoElectronico || "";

                    $emailInput
                        .val(email)
                        .prop("disabled", false);

                    $infoMultiple.addClass("d-none");
                } else {
                    // Múltiples empleados
                    $emailInput
                        .val("")
                    ...
                    $infoMultiple.removeClass("d-none");
                }
            ...
            Send: function () {
                ...
                var isMultiple = $emailInput.prop("disabled");

                // validar email de un solo empleado
                if (!isMultiple) {
                    var validationResult = this.Validate(emailValue);
                    ...
                    if (!validationResult.valido) {
                        ...
                        Swal.fire({
                            ...
                            html: "<strong>" + validationResult.mensaje + "<\/strong><br><br>Por favor ingrese un email válido con el formato:<br><code>ejemplo" + u + "dominio.com<\/code>",
                            confirmButtonText: "Entendido"
                        });
                        return;
                    }
                ...
                // Mensaje según tipo de envío
                var mensajeDestino = isMultiple
                    ? "Se enviará a múltiples destinatarios"
                    : "El email ha sido enviado a: <strong>" + emailValue + "</strong>";
