    ...
    public async Task<List<Employee>> ObtenerEmployeesAsync()
    {
        ...
        var empleados = new List<Employee>
        {
            ...
            { 
                ...
                EmailPersonal = "alexander@gmail.com",
            ...
            { 
                ...
                EmailPersonal = "ALBERTO@GMAIL.COM",
